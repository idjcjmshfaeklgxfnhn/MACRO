...
if WinActive("Roblox")
	...
	{
	msgbox, where is roblox? OPEN IT!
	exitapp
	}
...
tooltip, Made By FOXONFIRE567, %TooltipX%, %Tooltip1%, 1
tooltip, Time Running: 0h 0m 0s, %TooltipX%, %Tooltip2%, 2

tooltip, Press "P" to Start, %TooltipX%, %Tooltip4%, 4
tooltip, Press "O" to stop/reload, %TooltipX%, %Tooltip5%, 5
